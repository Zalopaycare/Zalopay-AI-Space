        ...
        {user ? (
          <div style={{ position: 'relative' }} ref={menuRef}>
            <div
              ...
              style={css('display:flex; align-items:center; gap:11px; padding:5px 15px 5px 5px; border-radius:999px; background:rgba(255,255,255,.05); border:1px solid rgba(255,255,255,.18); cursor:pointer;')}
            >
              ...
              <span style={css('font-family:inherit; font-size:15px; font-weight:600; color:#fff; white-space:nowrap;')}>{user.name}</span>
